...
const CahsregisterConfigModal: React.FC<ModalConfigI> = ({visible, config, handlerSet}) => {
    const [formModal] = Form.useForm<CashregisterConfig>()
...
interface ModalConfigI {
       visible: boolean;
        config: CashregisterConfig | undefined;
    handlerSet: (config: CashregisterConfig | undefined) => void;
}
